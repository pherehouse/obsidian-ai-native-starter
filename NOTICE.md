...
本项目仅为方便读者快速开始使用 Obsidian AI 原生工作空间，整理、附带或引导安装以下第三方插件：
...
- Terminal — [polyipseity/obsidian-terminal](https://github.com/polyipseity/obsidian-terminal)

插件作者、源代码和许可协议归各自原作者所有。本项目没有修改插件代码；如需最新版本或对许可有疑问，请优先从 Obsidian 社区插件页或原作者仓库安装。
